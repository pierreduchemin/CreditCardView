...
public enum IssuerCode implements Serializable {
    ...
    DISCOVER(R.string.discover, R.drawable.card_placeholder, R.drawable.default_card, R.drawable.default_card_back, R.drawable.sign_diners, R.color.white, R.color.gray_hard_text, "^6(?:011\\d{12}|5\\d{14}|4[4-9]\\d{13}|22(?:1(?:2[6-9]|[3-9]\\d)|[2-8]\\d{2}|9(?:[01]\\d|2[0-5]))\\d{10})$"),
    ...
    JCB(R.string.jcb, R.drawable.card_placeholder, R.drawable.default_card, R.drawable.default_card_back, R.drawable.sign_diners, R.color.white, R.color.gray_hard_text, "^(?:2131|1800|35\\d{3})\\d{11}$"),
